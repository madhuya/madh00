...
export default function Home() {
  return (
    <section className="bg-white dark:bg-gray-800">
      <div className="flex text-center bg-white relative">
        ...
        {/* <div className="hidden md:block absolute -bottom-56 -left-32 w-96 h-96">
          <div className="absolute text-extrabold text-xl right-16 z-20 text-start top-1/4">
            ...
            <p>Got a project ?</p>
            <a href="mailto:starktestic@gmail.com" className="underline">
              Let&#x27;s talk
            </a>
          </div>
          <svg
